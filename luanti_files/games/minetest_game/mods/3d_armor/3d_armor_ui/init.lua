...
armor:register_on_update(function(player)
	...
	if unified_inventory.current_page[name] == "g_armor" then
		unified_inventory.set_inventory_formspec(player, "g_armor")
	end
end)

unified_inventory.register_button("g_armor", {
	type = "image",
	image = "inventory_plus_armor.png",
	tooltip = S("3D Armor")
})

unified_inventory.register_page("g_armor", {
