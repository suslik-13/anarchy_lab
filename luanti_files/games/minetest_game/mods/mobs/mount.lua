...
function mobs.attach(entity, player)
	...
	local temp_attach_at = entity.driver_attach_at
	
	if temp_attach_at[2] == nil then
		local attach_at = {temp_attach_at[1], 2, temp_attach_at[3]}
	else
		local attach_at = temp_attach_at
	end
