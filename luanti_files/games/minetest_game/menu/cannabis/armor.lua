...
if minetest.get_modpath("cannabis") then
	local stats = {
        ...
        tessuto= { name="tessuto",fire=4, armor=2.0, heal=6, use=50},
		foglie = { name="foglie",fire=4, armor=2.7, heal=4, use=10},
		fibra = { name="fibra", fire=5,armor=3.8, heal=6, use=100, jump=0.2, armor_water=1},
		high = { name="high_performance",fire=5, armor=3.9, heal=7, use=70, speed=0.2},
